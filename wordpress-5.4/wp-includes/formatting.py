...
def sanitize_option(option_=None, value_=None, *_args_):
    ...
    for case in Switch(option_):
        ...
        if case("new_admin_email"):
            ...
            break
        # end if
        if case("thumbnail_size_w"):
            pass
        # end if
        if case("thumbnail_size_h"):
            pass
        # end if
        if case("medium_size_w"):
            pass
        # end if
        if case("medium_size_h"):
            pass
        # end if
        if case("medium_large_size_w"):
            pass
        # end if
        if case("medium_large_size_h"):
            pass
        # end if
        if case("large_size_w"):
            pass
        # end if
        if case("large_size_h"):
            pass
        # end if
        if case("mailserver_port"):
            pass
        # end if
        if case("comment_max_links"):
            pass
        # end if
        if case("page_on_front"):
            pass
        # end if
        if case("page_for_posts"):
            pass
        # end if
        if case("rss_excerpt_length"):
            pass
        # end if
        if case("default_category"):
            pass
        # end if
        if case("default_email_category"):
            pass
        # end if
        if case("default_link_category"):
            pass
        # end if
        if case("close_comments_days_old"):
            pass
        # end if
        if case("comments_per_page"):
            pass
        # end if
        if case("thread_comments_depth"):
            pass
        # end if
        if case("users_can_register"):
            pass
        # end if
        if case("start_of_week"):
            pass
        # end if
        if case("site_icon"):
        ...
        if case("time_format"):
            pass
        # end if
        if case("mailserver_url"):
            pass
        # end if
        if case("mailserver_login"):
            pass
        # end if
        if case("mailserver_pass"):
            pass
        # end if
        if case("upload_path"):
            value_ = wpdb_.strip_invalid_text_for_column(wpdb_.options, "option_value", value_)
        ...
        if case("timezone_string"):
            ...
            break
        # end if
        if case("permalink_structure"):
            pass
        # end if
        if case("category_base"):
            pass
        # end if
        if case("tag_base"):
            value_ = wpdb_.strip_invalid_text_for_column(wpdb_.options, "option_value", value_)
...
def _print_emoji_detection_script(*_args_):
    ...
    if SCRIPT_DEBUG:
        ...
        """)
    # end if
# end def _print_emoji_detection_script
#// 
