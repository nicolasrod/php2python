...
#//
class ParagonIE_Sodium_Core32_ChaCha20_IetfCtx(ParagonIE_Sodium_Core32_ChaCha20_Ctx):
    #// 
    ...
    def __init__(self, key_="", iv_="", counter_=""):
        ...
        # end if
        self.container[13] = ParagonIE_Sodium_Core32_Int32.fromreversestring(self.substr(iv_, 0, 4))
        self.container[14] = ParagonIE_Sodium_Core32_Int32.fromreversestring(self.substr(iv_, 4, 4))
        self.container[15] = ParagonIE_Sodium_Core32_Int32.fromreversestring(self.substr(iv_, 8, 4))
    # end def __init__
# end class ParagonIE_Sodium_Core32_ChaCha20_IetfCtx
