...
class ParagonIE_Sodium_Core32_Curve25519_Ge_Cached():
    ...
    def __init__(self, YplusX=None, YminusX=None, Z=None, T2d=None):
        ...
        if YplusX == None:
            YplusX = php_new_class("ParagonIE_Sodium_Core32_Curve25519_Fe", lambda : ParagonIE_Sodium_Core32_Curve25519_Fe())
        # end if
        self.YplusX = YplusX
        if YminusX == None:
            YminusX = php_new_class("ParagonIE_Sodium_Core32_Curve25519_Fe", lambda : ParagonIE_Sodium_Core32_Curve25519_Fe())
        # end if
        ...
        self.Z = Z
        if T2d == None:
            T2d = php_new_class("ParagonIE_Sodium_Core32_Curve25519_Fe", lambda : ParagonIE_Sodium_Core32_Curve25519_Fe())
        # end if
        self.T2d = T2d
    # end def __init__
