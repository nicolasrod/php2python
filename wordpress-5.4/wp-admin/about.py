...
php_print("\">\n                <a href=\"about.php\" class=\"nav-tab nav-tab-active\" aria-current=\"page\">")
_e("What&#8217;s New")
...
<h1>""")
_e("Say hello to more and better.")
php_print("</h1>\n\n            <p>")
_e("More ways to make your pages come alive. With easier ways to get it all done and looking better than ever&mdash;and boosts in speed you can feel.")
php_print("""</p>
</div>
<hr />
...
<p>
""")
_e("Every major release adds more to the block editor.")
php_print("             </p>\n              <p>\n                   ")
_e("More ways to make posts and pages come alive with your best images.")
php_print("                 ")
_e("More ways to bring your visitors in, and keep them engaged, with the richness of embedded media from the web&#8217;s top services.")
php_print("""               </p>
</div>
<div class=\"column\">
<p>
""")
_e("More ways to make your vision real, and put blocks in the perfect place&mdash;even if a particular kind of block is new to you. More efficient processes.")
php_print("             </p>\n              <p>\n                   ")
_e("And more speed everywhere, so as you build sections or galleries, or just type in a line of prose, you can feel how much faster your work flows.")
php_print("""               </p>
</div>
</div>
<hr />
...
<h2>""")
_e("Two new blocks. And better blocks overall.")
php_print("</h2>\n              <ul>\n                  <li>")
_e("Two brand-new blocks: Social Icons and Buttons make adding interactive features fast and easy.")
php_print("</li>\n                  <li>")
_e("New ways with color: Gradients in the Buttons and Cover block, toolbar access to color options in Rich Text blocks, and for the first time, color options in the Group and Columns blocks.")
php_print("</li>\n                  <li>")
_e("Guess a whole lot less! Version 5.4 streamlines the whole process for placing and replacing multimedia in every block. Now it works the same way in almost every block!")
php_print("</li>\n                  <li>")
_e("And if you&#8217;ve ever thought your image in the Media+Text block should link to something else&mdash;perhaps a picture of a brochure should download that brochure as a document? Well, now it can.")
php_print("""</li>
</ul>
</div>
</div>
...
<div class=\"column is-vertically-aligned-center\">
<h2>""")
_e("Cleaner UI, clearer navigationâand easier tabbing!")
php_print("</h2>\n              <ul>\n                  <li>")
_e("Clearer block navigation with block breadcrumbs. And easier selection once you get there.")
php_print("</li>\n                  <li>")
_e("For when you need to navigate with the keyboard, better tabbing and focus. Plus, you can tab over to the sidebar of nearly any block.")
php_print("</li>\n                  <li>")
_e("Speed! 14% faster loading of the editor, 51% faster time-to-type!")
php_print("</li>\n                  <li>")
_e("Tips are gone. In their place, a Welcome Guide window you can bring up when you need it&mdash;and only when you need it&mdash;again and again.")
php_print("</li>\n                  <li>")
_e("Know at a glance whether you&#8217;re in a block&#8217;s Edit or Navigation mode. Or, if you have restricted vision, your screen reader will tell you which mode you&#8217;re in.")
php_print("</li>\n              </ul>\n             <p>")
_e("Of course, if you want to work with the very latest tools and features, install the <a href=\"https://wordpress.org/plugins/gutenberg/\">Gutenberg plugin</a>. You&#8217;ll get to be the first to use new and exciting features in the block editor, before anyone else has seen them!")
php_print("""</p>
</div>
<div class=\"column is-edge-to-edge\">
<div class=\"about__image aligncenter\">
...
<div class=\"column is-vertically-aligned-center\">
<h2>""")
_e("Your fundamental right: privacy")
php_print("</h2>\n              <p>")
_e("5.4 helps with a variety of privacy issues around the world. So when users and stakeholders ask about regulatory compliance, or how your team handles user data, the answers should be a lot easier to get right.")
php_print("</p>\n               <p>")
_e("Take a look:")
php_print("</p>\n               <ul>\n                  <li>")
_e("Now personal data exports include users session information and users location data from the community events widget. Plus, a table of contents!")
php_print("</li>\n                  <li>")
_e("See progress as you process export and erasure requests through the privacy tools.")
php_print("</li>\n                  <li>")
_e("Plus, little enhancements throughout give the privacy tools a little cleaner look. Your eyes will thank you!")
php_print("""</li>
</ul>
</div>
</div>
...
<div class=\"column\">
<h3>""")
_e("Add custom fields to menu itemsânatively")
php_print("</h3>\n              <p>\n                   ")
...
<div class=\"column\">
<h3>""")
_e("Blocks! Simpler styling, new APIs and embeds")
php_print("</h3>\n              <ul>\n                  <li>")
_e("<strong>Radically</strong> simpler block styling. Negative margins and default padding are gone! Now you can style blocks the way you need them. And, a refactor got rid of four redundant wrapper divs.")
php_print("</li>\n                  <li>")
_e("If you build plugins, now you can register collections of your blocks by namespace across categoriesâa great way to get more brand visibility.")
php_print("</li>\n                  <li>")
_e("Let users do more with two new APIs: block variations and gradients.")
php_print("</li>\n                  <li>")
_e("In embeds, now the block editor supports TikTokâand CollegeHumor is gone.")
php_print("""</li>
</ul>
</div>
</div>
...
""")
if current_user_can("update_core") and (php_isset(lambda : PHP_REQUEST["updated"])):
    php_print("             <a href=\"")
    php_print(esc_url(self_admin_url("update-core.php")))
    php_print("\">\n                    ")
    _e("Return to Updates") if is_multisite() else _e("Return to Dashboard &rarr; Updates")
    php_print("             </a> |\n            ")
# end if
php_print("         <a href=\"")
php_print(esc_url(self_admin_url()))
php_print("\">")
