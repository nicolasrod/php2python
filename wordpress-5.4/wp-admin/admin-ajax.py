...
if is_user_logged_in():
    ...
    if (not has_action(str("wp_ajax_") + str(action_))):
        wp_die("0", 400)
    # end if
    #// 
    ...
    #// @since 2.1.0
    #//
    do_action(str("wp_ajax_") + str(action_))
else:
    #// If no action is registered, return a Bad Request response.
    if (not has_action(str("wp_ajax_nopriv_") + str(action_))):
        wp_die("0", 400)
    # end if
    #// 
    ...
    #// @since 2.8.0
    #//
    do_action(str("wp_ajax_nopriv_") + str(action_))
# end if
#// Default status.
wp_die("0")
