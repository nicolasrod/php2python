...
def options_discussion_add_js(*_args_):
    ...
    """)
# end def options_discussion_add_js
#// 
...
def options_general_add_js(*_args_):
    ...
    homeURL = ( """)
    php_print(wp_json_encode(get_home_url()))
    php_print(""" || '' ).replace( /^(https?:\\/\\/)?(www\\.)?/, '' );
...
if ( ! languageSelect.find( 'option:selected' ).data( 'installed' ) ) {
    ...
    """)
# end def options_general_add_js
#// 
#// Display JavaScript on the page.
#// 
#// @since 3.5.0
...
def options_reading_add_js(*_args_):
    ...
    """)
# end def options_reading_add_js
#// 
...
# end def options_reading_blog_charset
