...
#//
def register_column_headers(screen_=None, columns_=None, *_args_):
    
    
    php_new_class("_WP_List_Table_Compat", lambda : _WP_List_Table_Compat(screen_, columns_))
...
#//
def print_column_headers(screen_=None, with_id_=None, *_args_):
    if with_id_ is None:
        with_id_ = True
    # end if
    
    wp_list_table_ = php_new_class("_WP_List_Table_Compat", lambda : _WP_List_Table_Compat(screen_))
    wp_list_table_.print_column_headers(with_id_)
