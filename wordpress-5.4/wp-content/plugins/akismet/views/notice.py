...
if type_ == "plugin":
    ...
    printf(esc_html__("Akismet Error Code: %s", "akismet"), code_)
    php_print("</strong></p>\n  <p>")
    php_print(esc_html(msg_))
    php_print("</p>\n   <p>")
    #// translators: the placeholder is a clickable URL that leads to more information regarding an error code.
    printf(esc_html__("For more information: %s", "akismet"), "<a href=\"https://akismet.com/errors/" + code_ + "\">https://akismet.com/errors/" + code_ + "</a>")
    php_print(" </p>\n</div>\n")
elif type_ == "notice":
    ...
    if check_pending_link_:
        ...
        printf(__("Would you like to <a href=\"%s\">check pending comments</a>?", "akismet"), esc_url(check_pending_link_))
        php_print("</p>\n   ")
    # end if
    php_print("</div>\n")
