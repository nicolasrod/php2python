...
if (not php_class_exists("TwentyTwenty_Customize")):
    ...
    class TwentyTwenty_Customize():
        ...
        #//
        @classmethod
        def register(self, wp_customize_=None):
            ...
            wp_customize_.selective_refresh.add_partial("blogname", Array({"selector": ".site-title a", "render_callback": "twentytwenty_customize_partial_blogname"}))
            wp_customize_.selective_refresh.add_partial("blogdescription", Array({"selector": ".site-description", "render_callback": "twentytwenty_customize_partial_blogdescription"}))
            wp_customize_.selective_refresh.add_partial("custom_logo", Array({"selector": ".header-titles [class*=site-]:not(.site-description)", "render_callback": "twentytwenty_customize_partial_site_logo"}))
            wp_customize_.selective_refresh.add_partial("retina_logo", Array({"selector": ".header-titles [class*=site-]:not(.site-description)", "render_callback": "twentytwenty_customize_partial_site_logo"}))
            #// 
            #// Site Identity
            #// 
            #// 2X Header Logo ----------------
            ...
            wp_customize_.get_setting("background_color").transport = "postMessage"
            #// 
            #// Theme Options
            #//
            ...
            #// Separator ---------------------
            wp_customize_.add_setting("cover_template_separator_1", Array({"sanitize_callback": "wp_filter_nohtml_kses"}))
            wp_customize_.add_control(php_new_class("TwentyTwenty_Separator_Control", lambda : TwentyTwenty_Separator_Control(wp_customize_, "cover_template_separator_1", Array({"section": "cover_template_options"}))))
            #// Overlay Background Color ------
            wp_customize_.add_setting("cover_template_overlay_background_color", Array({"default": twentytwenty_get_color_for_area("content", "accent"), "sanitize_callback": "sanitize_hex_color"}))
            wp_customize_.add_control(php_new_class("WP_Customize_Color_Control", lambda : WP_Customize_Color_Control(wp_customize_, "cover_template_overlay_background_color", Array({"label": __("Overlay Background Color", "twentytwenty"), "description": __("The color used for the overlay. Defaults to the accent color.", "twentytwenty"), "section": "cover_template_options"}))))
            #// Overlay Text Color ------------
            wp_customize_.add_setting("cover_template_overlay_text_color", Array({"default": "#ffffff", "sanitize_callback": "sanitize_hex_color"}))
            wp_customize_.add_control(php_new_class("WP_Customize_Color_Control", lambda : WP_Customize_Color_Control(wp_customize_, "cover_template_overlay_text_color", Array({"label": __("Overlay Text Color", "twentytwenty"), "description": __("The color used for the text in the overlay.", "twentytwenty"), "section": "cover_template_options"}))))
            #// Overlay Color Opacity ---------
            wp_customize_.add_setting("cover_template_overlay_opacity", Array({"default": 80, "sanitize_callback": "absint", "transport": "postMessage"}))
            wp_customize_.add_control("cover_template_overlay_opacity", Array({"label": __("Overlay Opacity", "twentytwenty"), "description": __("Make sure that the contrast is high enough so that the text is readable.", "twentytwenty"), "section": "cover_template_options", "type": "range", "input_attrs": twentytwenty_customize_opacity_range()}))
            wp_customize_.selective_refresh.add_partial("cover_template_overlay_opacity", Array({"selector": ".cover-color-overlay", "type": "cover_opacity"}))
        # end def register
        #// 
        ...
        #//
        @classmethod
        def sanitize_accent_accessible_colors(self, value_=None):
        ...
        #//
        @classmethod
        def sanitize_select(self, input_=None, setting_=None):
            
            
            input_ = sanitize_key(input_)
            choices_ = setting_.manager.get_control(setting_.id).choices
            return input_ if php_array_key_exists(input_, choices_) else setting_.default
        ...
        #//
        @classmethod
        def sanitize_checkbox(self, checked_=None):
            
            
            return True if (php_isset(lambda : checked_)) and True == checked_ else False
...
if (not php_function_exists("twentytwenty_customize_partial_blogname")):
    ...
    #//
    def twentytwenty_customize_partial_blogname(*_args_):
...
if (not php_function_exists("twentytwenty_customize_partial_blogdescription")):
    ...
    #//
    def twentytwenty_customize_partial_blogdescription(*_args_):
...
if (not php_function_exists("twentytwenty_customize_partial_site_logo")):
    ...
    #//
    def twentytwenty_customize_partial_site_logo(*_args_):
...
#//
def twentytwenty_customize_opacity_range(*_args_):
