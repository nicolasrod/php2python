...
if (not php_class_exists("TwentyTwenty_Non_Latin_Languages")):
    ...
    class TwentyTwenty_Non_Latin_Languages():
        ...
        #//
        @classmethod
        def get_non_latin_css(self, type="front-end"):
            ...
            if php_empty(lambda : font_family[locale]):
                return
            # end if
            ...
            if php_empty(lambda : elements[type]):
                return
            # end if
            #// Return the specified styles.
            return twentytwenty_generate_css(php_implode(",", elements[type]), "font-family", php_implode(",", font_family[locale]), None, None, False)
