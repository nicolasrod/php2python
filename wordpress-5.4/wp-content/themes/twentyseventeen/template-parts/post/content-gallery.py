...
if "" != get_the_post_thumbnail() and (not is_single()) and (not get_post_gallery()):
...
if (not is_single()):
    ...
    if get_post_gallery():
        php_print("<div class=\"entry-gallery\">")
        php_print(get_post_gallery())
        php_print("</div>")
    # end if
# end if
if is_single() or (not get_post_gallery()):
