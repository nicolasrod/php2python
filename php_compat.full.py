...
def php_array_merge_recursive(*args):
    ...
    {'color': {'favorite': {0: 'red', 1: 'green'}, 'blue'}, 0: 5, 1: 10}
    """
    out = Array()
    for i in args:
        out.extend(i)
...
def php_exif_read_data(_stream,
                       _sections=None,
                       _arrays=False,
                       _thumbnail=False):
    pass
...
def php_get_html_translation_table(_table=HTML_SPECIALCHARS,
                                   _flags=ENT_COMPAT | ENT_HTML401,
                                   _encoding="UTF-8"):
    pass
...
def php_gmmktime(_hour=gmdate("H"),
                 _minute=gmdate("i"),
                 _second=gmdate("s"),
                 _month=gmdate("n"),
                 _day=gmdate("j"),
...
def php_html_entity_decode(_string,
                           _flags=ENT_COMPAT | ENT_HTML401,
                           _encoding="UTF-8"):
    pass


def php_htmlspecialchars(_string,
                         _flags=ENT_COMPAT | ENT_HTML401,
                         _encoding="UTF-8",
                         _double_encode=True):
    pass
...
def php_http_build_query(_query_data,
                         _numeric_prefix,
                         _arg_separator,
                         _enc_type=PHP_QUERY_RFC1738):
    pass
...
def php_idn_to_ascii(_domain,
                     _options=IDNA_DEFAULT,
                     _variant=INTL_IDNA_VARIANT_UTS46,
                     _idna_info=None):
    pass
...
def php_imagecopy(_dst_im, _src_im, _dst_x, _dst_y, _src_x, _src_y, _src_w,
                  _src_h):
    pass


def php_imagecopyresampled(_dst_image, _src_image, _dst_x, _dst_y, _src_x,
                           _src_y, _dst_w, _dst_h, _src_w, _src_h):
    pass
...
def php_mail(_to, _subject, _message, _additional_headers,
...
def php_number_format(_number=None,
                      _decimals=0,
                      _dec_point=".",
                      _thousands_sep=","):
    pass
...
def php_ob_end_clean():
    pass


def php_ob_end_flush():
    pass


def php_ob_get_clean():
    pass


def php_ob_get_contents():
    pass


def php_ob_get_flush():
    pass


def php_ob_get_length():
    pass


def php_ob_get_level():
    pass


def php_ob_start(_output_callback=None,
                 _chunk_size=0,
                 _flags=PHP_OUTPUT_HANDLER_STDFLAGS,
                 _buffer=None,
                 _phase=None):
    pass


def php_opcache_invalidate(_script, _force=False):
    pass


def php_openssl_decrypt(_data,
                        _method,
                        _key,
                        _options=0,
                        _iv="",
...
def php_openssl_pkcs7_sign(_infilename,
                           _outfilename,
                           _signcert,
                           _privkey,
                           _headers,
                           _flags=PKCS7_DETACHED,
                           _extracerts=None):
    pass
...
def php_openssl_private_encrypt(_data,
                                _crypted,
                                _key,
                                _padding=OPENSSL_PKCS1_PADDING):
    pass


def php_openssl_sign(_data,
                     _signature,
                     _priv_key_id,
                     _signature_alg=OPENSSL_ALGO_SHA1):
    pass
...
def php_pathinfo(_path,
                 _options=PATHINFO_DIRNAME | PATHINFO_BASENAME
...
def php_preg_match_all(_pattern,
                       _subject,
                       _matches,
                       _flags=PREG_PATTERN_ORDER,
                       _offset=0):
    pass
...
def php_preg_replace_callback(_pattern,
                              _callback,
                              _subject,
                              _limit=-1,
                              _count=None,
...
def php_scandir(_directory,
                _sorting_order=SCANDIR_SORT_ASCENDING,
                _context=None):
    pass
...
def php_set_error_handler(_error_handler,
                          _error_types=None,
                          _errno=None,
                          _errstr=None,
                          _errfile=None,
...
def php_simplexml_load_string(_data,
                              _class_name="SimpleXMLElement",
                              _options=0,
                              _ns="",
                              _is_prefix=False):
    pass
...
def php_sodium_crypto_aead_chacha20poly1305_decrypt(_ciphertext, _ad, _nonce,
                                                    _key):
    pass
...
def php_sodium_crypto_aead_chacha20poly1305_ietf_decrypt(
        _ciphertext, _ad, _nonce, _key):
    pass


def php_sodium_crypto_aead_chacha20poly1305_ietf_encrypt(
        _msg, _ad, _nonce, _key):
    pass


def php_sodium_crypto_aead_xchacha20poly1305_ietf_decrypt(
        _ciphertext, _ad, _nonce, _key):
    pass


def php_sodium_crypto_aead_xchacha20poly1305_ietf_encrypt(
        _msg, _ad, _nonce, _key):
    pass
...
def php_sodium_crypto_box_keypair_from_secretkey_and_publickey(
        _secret_key, _public_key):
    pass
...
def php_sodium_crypto_generichash(_msg,
                                  _key,
                                  _length=SODIUM_CRYPTO_GENERICHASH_BYTES):
    pass


def php_sodium_crypto_generichash_final(_state,
                                        _length=SODIUM_CRYPTO_GENERICHASH_BYTES
                                        ):
    pass


def php_sodium_crypto_generichash_init(_key,
                                       _length=SODIUM_CRYPTO_GENERICHASH_BYTES
                                       ):
    pass
...
def php_sodium_crypto_pwhash(_length, _password, _salt, _opslimit, _memlimit,
                             _alg):
    pass


def php_sodium_crypto_pwhash_scryptsalsa208sha256(_length, _password, _salt,
                                                  _opslimit, _memlimit):
    pass


def php_sodium_crypto_pwhash_scryptsalsa208sha256_str(_password, _opslimit,
                                                      _memlimit):
    pass
...
def php_sodium_crypto_sign_keypair_from_secretkey_and_publickey(
        _secret_key, _public_key):
    pass
...
def php_ssh2_auth_pubkey_file(_session, _username, _pubkeyfile, _privkeyfile,
                              _passphrase):
    pass
...
def php_ssh2_exec(_session,
                  _command,
                  _pty,
                  _env,
                  _width=80,
                  _height=25,
                  _width_height_type=SSH2_TERM_UNIT_CHARS):
    pass
...
def php_stream_socket_client(_remote_socket,
                             _errno,
                             _errstr,
                             _timeout=None,
                             _flags=STREAM_CLIENT_CONNECT,
                             _context=None):
    pass


def php_stream_socket_enable_crypto(_stream, _enable, _crypto_type,
                                    _session_stream):
    pass
...
def php_xml_set_element_handler(_parser, _start_element_handler,
